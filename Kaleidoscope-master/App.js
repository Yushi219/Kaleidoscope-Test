...
class App extends Component {
  ...
  //     {
  //       element: '#parentDiv',
  //       intro: 'filter whatever you want',
  //       position: 'right',
  //     },
  //     {
  //       element: '#share',
  //       intro: 'You can use this button to share result',
  //     },
  //     {
  //       element: '#stepOne',
  //       intro: 'I guess this is step one',
  //     },
  //  ];
    ...
    return (
      <div className="App" style={{ minHeight: sidebarHeight }}>
        ...
        <h4 style={{ position: "absolute", right: "150px", top: "60px" }}>
          <button onClick={introJs().start()} style={{ borderRadius: "5px", padding: "5px" }}>Start Tour</button>
        </h4>
        
        <h4 style={{ position: "absolute", right: "25px", top: "60px" }}>
        ...
        <AppBar position="static" style={{ background: 'white', color: 'black', boxShadow: "none" }}>
          <Tabs value={this.state.value} indicatorColor="secondary" textColor="secondary"
            ...
            <Tab data-step="1" data-title='Step One' data-intro='Select a category' label="ENVELOPES" />
            <Tab label="FLOORING" />
            <Tab label="CEILINGS" />
        ...
        <TabPanel  className={styles.tabPanel} value={this.state.value} index={TAB_INDEX_ENVELOPES}>
          ...
          <form>
            ...
            <div data-step="2" data-title='Step Two' data-intro='Select a type' className={styles.topcontrols}>
          ...
          <div id="parentDiv">
            <div data-step="3" data-title='Step Three' data-intro='Select materials' className={styles.sidebar} id="sidebar123">
            ...
            <div data-step="4" data-title='Step Four' data-intro='See the result' className={styles.chartContainer}>
              <h2>{chartTitle}</h2>
              ...
              {/* Envelope Calculator */}
              <div data-step="5" data-title='Step Five' data-intro='Compare materials with area' style={{ display: "inline-block", width: "100%" }}>
                ...
                <div className={styles.calc} style={{ minHeight: '60px', width: '95%', display: "block" }}>
                  ...
                  <button id="stepOne" onClick={this.addRow}>
                    Add Option
                  </button>
